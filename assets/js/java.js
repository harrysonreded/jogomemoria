var BoxOpened = "";
                ...
                var score = 0;
				var ImgSource = [
				  "assets/imagens/img1.png",
				  "assets/imagens/img2.jpeg",
				  "assets/imagens/img3.jpeg",
				  "assets/imagens/img4.png",
				  "assets/imagens/img5.png",
				  "assets/imagens/img6.jpeg",
				  "assets/imagens/img7.jpeg",
				  "assets/imagens/img8.jpeg",				  
				];
...
// debugger;
						$("#" + $(ImgThis).attr("id") + ' div').css("background-image", ImgArr[RandomNumber]);//assign backgroundimage to div neby one//#card10 div
